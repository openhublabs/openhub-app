...
class ExplorarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textoTituloFragmento.text = getString(R.string.titulo_explorar)
        binding.textoSubtituloFragmento.text = getString(R.string.subtitulo_explorar)
    ...
    private fun observarDatos() {
        viewModel.eventos.observe(viewLifecycleOwner) { lista ->
            // Simulating exploration by reversing the list
            adaptador.submitList(lista.reversed())
        }
    }
